...
#endif
vmCvar_t	g_weaponOrder1;			//the 1st weapon a player gets
vmCvar_t	g_weaponOrder2;			//the 2nd weapon a player gets
vmCvar_t	g_weaponOrder3;			//the 3rd weapon a player gets
vmCvar_t	g_weaponOrder4;			//the 4th weapon a player gets
vmCvar_t	g_weaponOrder5;			//the 5th weapon a player gets
vmCvar_t	g_weaponOrder6;			//the 6th weapon a player gets
vmCvar_t	g_weaponOrder7;			//the 7th weapon a player gets
