...
void G_SpawnItem (gentity_t *ent, gitem_t *item) {
	//TODO: Check if we can't simply free the entity in G_SpawnGEntityFromSpawnVars if it's a weapon or ammo. With the current implementation there's an unused entity left in memory.
	if (item->giType != IT_WEAPON && item->giType != IT_AMMO)	//we don't want to spawn weapons or ammo in this mod
	{
