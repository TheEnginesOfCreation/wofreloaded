...
struct gclient_s {
	...
	int			currentWeapon;		// Weapon currently held by client. In this mod, client carries only one single weapon.
									// this number does not refer to the weapon numbers themselves (as in 1 = gauntlet, 2 = MG, 3 = SG, etc)
									// but to the Nth weapon in the weapon order (as defined by the g_weaponOrder server cvars).
