...
Gives client the next weapon in the weapon order
=================
*/
...
Gets the current weapon based on order number.
=================
*/
...
*/
int GetFinalWeapon() {
	if (g_weaponOrder9.string != "" && g_weaponOrder9.integer > 0 && g_weaponOrder9.integer < WP_NUM_WEAPONS && g_weaponOrder9.integer != WP_GRAPPLING_HOOK)
		return 9;
	if (g_weaponOrder8.string != "" && g_weaponOrder8.integer > 0 && g_weaponOrder8.integer < WP_NUM_WEAPONS && g_weaponOrder8.integer != WP_GRAPPLING_HOOK)
		return 8;
	if (g_weaponOrder7.string != "" && g_weaponOrder7.integer > 0 && g_weaponOrder7.integer < WP_NUM_WEAPONS && g_weaponOrder7.integer != WP_GRAPPLING_HOOK)
		return 7;
	if (g_weaponOrder6.string != "" && g_weaponOrder6.integer > 0 && g_weaponOrder6.integer < WP_NUM_WEAPONS && g_weaponOrder6.integer != WP_GRAPPLING_HOOK)
		return 6;
	if (g_weaponOrder5.string != "" && g_weaponOrder5.integer > 0 && g_weaponOrder5.integer < WP_NUM_WEAPONS && g_weaponOrder5.integer != WP_GRAPPLING_HOOK)
		return 5;
	if (g_weaponOrder4.string != "" && g_weaponOrder4.integer > 0 && g_weaponOrder4.integer < WP_NUM_WEAPONS && g_weaponOrder4.integer != WP_GRAPPLING_HOOK)
		return 4;
	if (g_weaponOrder3.string != "" && g_weaponOrder3.integer > 0 && g_weaponOrder3.integer < WP_NUM_WEAPONS && g_weaponOrder3.integer != WP_GRAPPLING_HOOK)
		return 3;
	if (g_weaponOrder2.string != "" && g_weaponOrder2.integer > 0 && g_weaponOrder2.integer < WP_NUM_WEAPONS && g_weaponOrder2.integer != WP_GRAPPLING_HOOK)
		return 2;
	if (g_weaponOrder1.string != "" && g_weaponOrder1.integer > 0 && g_weaponOrder1.integer < WP_NUM_WEAPONS && g_weaponOrder1.integer != WP_GRAPPLING_HOOK)
		return 1;
...
void TossClientItems( gentity_t *self ) {
	...
	// weapon dropping code was removed. We don't want weapons to be dropped.
