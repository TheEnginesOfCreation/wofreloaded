...
void BotChooseWeapon(bot_state_t *bs) {
	...
	if (bs->cur_ps.weaponstate == WEAPON_RAISING ||
		...
		//note: for some reason trap_BotChooseBestFightWeapon always returns 0, so as a quick 'n dirty fix I've removed the function call
		//and replaced it with the less than elegant solution below. -Eraser
		//TODO: Figure out what trap_BotChooseBestFightWeapon does and why it returns 0
